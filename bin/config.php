...
// This is a PHP source file.  Pay heed to match quotes and parentheses.
...
// *** Site path settings ***
// The base system path to W2.  You shouldn't have to change this.
...
define('PAGES_PATH', "/www/stevenf/laguna2/pages");					// Omit any trailing slash
...
//$allowedIPs = array('66.93.40.145', '32.', '67.160.1');
$allowedIPs = array();
